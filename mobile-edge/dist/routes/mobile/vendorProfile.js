...
import { mobileVendorProfilePayload } from "../../contract/mobile/vendor/profile.js";
...
export default async function route(app) {
    ...
    app.get("/vendor/profile/:vendorId", { schema: schemas.profile }, async (request, reply) => {
        ...
        const result = await vendoringApiClient.getProfile(vendorId, forwardedHeaders(request));
